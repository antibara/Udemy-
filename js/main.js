...
incomeItem.addEventListener('input', function(){//change тоже можно
...
sumValue.addEventListener('input', function(){
    if(appData.savings == true){
        let sun = sumValue.value;
        let percent = +percentValue.value

            appData.monthIncome = sun/100/12*percent;
            appData.yearIncome = sun/100*percent;
